    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col selection:bg-purple-100 selection:text-purple-900 pb-16">
      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-2xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          {/* Brand & Client Site Return Link */}
          <div className="flex items-center gap-3">
            <a
              href="/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 hover:text-slate-900 text-xs font-bold border border-slate-200 transition-colors cursor-pointer"
              title="Open Client Site in New Tab"
            >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded-full text-[10px] font-extrabold bg-purple-100 text-purple-700 border border-purple-200 uppercase tracking-wider">
                    Manager Portal
                  </span>
                </div>
              </div>
          ...
          <div className="hidden lg:flex items-center gap-1 bg-slate-100/90 p-1 rounded-full border border-slate-200/80">
            <button
            ...
            >
              ...
              <span className={`px-1.5 py-0.2 rounded-full text-[10px] font-bold ${
                adminTab === 'ledger' ? 'bg-purple-700 text-white' : 'bg-slate-200 text-slate-700'
              }`}>
                {bookings.length}
              </span>
            </button>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={onRefresh}
              className="p-2 rounded-xl bg-slate-100 text-slate-700 hover:bg-slate-200 border border-slate-200 transition-colors cursor-pointer"
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold bg-purple-600 hover:bg-purple-700 text-white shadow-xs transition-all cursor-pointer"
            >
        ...
        <div className="lg:hidden px-4 py-2 bg-slate-50 border-t border-slate-200 flex items-center gap-1.5 overflow-x-auto scrollbar-none">
          <button
            onClick={() => setAdminTab('ledger')}
            className={`px-3 py-1 rounded-lg text-xs font-bold whitespace-nowrap transition-all ${
              adminTab === 'ledger' ? 'bg-purple-600 text-white' : 'text-slate-600 hover:text-slate-900 bg-white border border-slate-200'
            }`}
          >
          ...
          <button
            onClick={() => setAdminTab('holds')}
            className={`px-3 py-1 rounded-lg text-xs font-bold whitespace-nowrap transition-all ${
              adminTab === 'holds' ? 'bg-amber-500 text-white' : 'text-slate-600 hover:text-slate-900 bg-white border border-slate-200'
            }`}
          >
            Holds Queue ({holds.length})
          </button>
          <button
            onClick={() => setAdminTab('analytics')}
            className={`px-3 py-1 rounded-lg text-xs font-bold whitespace-nowrap transition-all ${
              adminTab === 'analytics' ? 'bg-blue-600 text-white' : 'text-slate-600 hover:text-slate-900 bg-white border border-slate-200'
            }`}
          >
            Analytics
          </button>
          <button
            onClick={() => setAdminTab('calendar')}
            className={`px-3 py-1 rounded-lg text-xs font-bold whitespace-nowrap transition-all ${
              adminTab === 'calendar' ? 'bg-emerald-600 text-white' : 'text-slate-600 hover:text-slate-900 bg-white border border-slate-200'
            }`}
          >
            Calendar
          </button>
